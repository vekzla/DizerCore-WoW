...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_UPD_CHARACTER_HOUSING_DECOR_PET,
    CHAR_SEL_CHARACTER_HOUSING_IGNORED_NEIGHBORHOOD,
    CHAR_INS_CHARACTER_HOUSING_IGNORED_NEIGHBORHOOD,
    CHAR_DEL_CHARACTER_HOUSING_IGNORED_NEIGHBORHOOD,
    CHAR_SEL_ACCOUNT_HOUSING_BLUEPRINTS,
    CHAR_INS_ACCOUNT_HOUSING_BLUEPRINT,
    CHAR_UPD_ACCOUNT_HOUSING_BLUEPRINT_NAME,
    CHAR_DEL_ACCOUNT_HOUSING_BLUEPRINT,
