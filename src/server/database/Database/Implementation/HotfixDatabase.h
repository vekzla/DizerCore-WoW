...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_DYE_COLOR,  
    HOTFIX_SEL_DYE_COLOR_MAX_ID,  
    HOTFIX_SEL_DYE_COLOR_LOCALE,  
    HOTFIX_SEL_DYE_COLOR_CATEGORY,  
    HOTFIX_SEL_DYE_COLOR_CATEGORY_MAX_ID,  
    HOTFIX_SEL_DYE_COLOR_CATEGORY_LOCALE,  
	...
	HOTFIX_SEL_DELVES_SEASON,
    HOTFIX_SEL_DELVES_SEASON_MAX_ID,

    HOTFIX_SEL_DELVES_SEASON_X_SPELL,
    HOTFIX_SEL_DELVES_SEASON_X_SPELL_MAX_ID,
    ...
    HOTFIX_SEL_DRIVE_CAPABILITY,
    HOTFIX_SEL_DRIVE_CAPABILITY_MAX_ID,
    ...
    HOTFIX_SEL_PERKS_ACTIVITY_THRESHOLD,
    HOTFIX_SEL_PERKS_ACTIVITY_THRESHOLD_MAX_ID,

    HOTFIX_SEL_PERKS_ACTIVITY_THRESHOLD_GROUP,
    HOTFIX_SEL_PERKS_ACTIVITY_THRESHOLD_GROUP_MAX_ID,
    HOTFIX_SEL_PERKS_ACTIVITY_THRESHOLD_GROUP_LOCALE,

    HOTFIX_SEL_PERKS_ACTIVITY_X_INTERVAL,
    HOTFIX_SEL_PERKS_ACTIVITY_X_INTERVAL_MAX_ID,

    HOTFIX_SEL_PERKS_ACTIVITY_CONDITION,
    HOTFIX_SEL_PERKS_ACTIVITY_CONDITION_MAX_ID,

    HOTFIX_SEL_PERKS_ACTIVITY_TAG,
    HOTFIX_SEL_PERKS_ACTIVITY_TAG_MAX_ID,
    HOTFIX_SEL_PERKS_ACTIVITY_TAG_LOCALE,

    HOTFIX_SEL_PERKS_ACTIVITY_X_HOLIDAYS,

    HOTFIX_SEL_PERKS_ACTIVITY_X_TAG,
    HOTFIX_SEL_PERKS_ACTIVITY_X_TAG_MAX_ID,

    HOTFIX_SEL_PERKS_UI_THEME,
    HOTFIX_SEL_PERKS_UI_THEME_MAX_ID,

    HOTFIX_SEL_PERKS_VENDOR_CATEGORY,
    HOTFIX_SEL_PERKS_VENDOR_CATEGORY_MAX_ID,
    HOTFIX_SEL_PERKS_VENDOR_CATEGORY_LOCALE,

    HOTFIX_SEL_PERKS_VENDOR_ITEM,
    HOTFIX_SEL_PERKS_VENDOR_ITEM_MAX_ID,

    HOTFIX_SEL_PERKS_VENDOR_ITEM_UI_GROUP,
    HOTFIX_SEL_PERKS_VENDOR_ITEM_UI_GROUP_MAX_ID,
    HOTFIX_SEL_PERKS_VENDOR_ITEM_UI_GROUP_LOCALE,

    HOTFIX_SEL_PERKS_VENDOR_ITEM_UI_INFO,
    HOTFIX_SEL_PERKS_VENDOR_ITEM_UI_INFO_MAX_ID,

    HOTFIX_SEL_PERKS_VENDOR_ITEM_X_INTERVAL,
    ...
    HOTFIX_SEL_PLAYER_COMPANION_INFO,
    HOTFIX_SEL_PLAYER_COMPANION_INFO_MAX_ID,
    HOTFIX_SEL_PLAYER_COMPANION_INFO_LOCALE,
    ...
    HOTFIX_SEL_WARBAND_SCENE_PLACEMENT,
    HOTFIX_SEL_WARBAND_SCENE_PLACEMENT_MAX_ID,

    HOTFIX_SEL_WARBAND_SCENE_ANIMATION,
    HOTFIX_SEL_WARBAND_SCENE_ANIMATION_MAX_ID,

    HOTFIX_SEL_WARBAND_SCENE_ANIM_CHR_SPEC,
    HOTFIX_SEL_WARBAND_SCENE_ANIM_CHR_SPEC_MAX_ID,

    HOTFIX_SEL_WARBAND_SCENE_PLACEMENT_FILTER_REQ,
    HOTFIX_SEL_WARBAND_SCENE_PLACEMENT_FILTER_REQ_MAX_ID,

    HOTFIX_SEL_WARBAND_SCENE_PLACEMENT_OPTION,
    HOTFIX_SEL_WARBAND_SCENE_PLACEMENT_OPTION_MAX_ID,

    HOTFIX_SEL_WARBAND_SCENE_PLCMNT_ANIM_OVERRIDE,
    HOTFIX_SEL_WARBAND_SCENE_PLCMNT_ANIM_OVERRIDE_MAX_ID,

    HOTFIX_SEL_WARBAND_PLACEMENT_DISPLAY_INFO,
    HOTFIX_SEL_WARBAND_PLACEMENT_DISPLAY_INFO_MAX_ID,

    HOTFIX_SEL_WARBAND_SCENE_SOURCE_INFO,
    HOTFIX_SEL_WARBAND_SCENE_SOURCE_INFO_MAX_ID,
    HOTFIX_SEL_WARBAND_SCENE_SOURCE_INFO_LOCALE,
