...
{  
    ...
    {  
        ...
        house->SetId(houseId);                              // ADDED  
        house->SetOwnerGuid(ownerGuid);                     // ADDED  
        house->SetPlotId(plotId);  
        house->SetHouseTemplateId(houseTemplateId);         // ADDED  
        house->SetHouseType(houseType);                     // ADDED  
        house->SetHouseStyle(houseStyle);                   // ADDED  
