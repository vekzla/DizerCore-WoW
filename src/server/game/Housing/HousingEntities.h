...
public:  
    ...
    // Setters  
    void SetId(uint32 houseId) { _houseId = houseId; }                          // ADDED  
    void SetOwnerGuid(ObjectGuid guid) { _ownerGuid = guid; }                   // ADDED  
    void SetPlotId(uint32 plotId) { _plotId = plotId; }  
    void SetHouseTemplateId(uint32 templateId) { _houseTemplateId = templateId; } // ADDED  
    void SetHouseType(uint8 type) { _houseType = type; }                        // ADDED  
    void SetHouseStyle(uint8 style) { _houseStyle = style; }                    // ADDED  
...
public:  
    ...
    // Setters  
    void SetId(uint32 neighborhoodId) { _neighborhoodId = neighborhoodId; }     // ADDED  
...
public:  
    ...
    // Setters  
    void SetId(uint32 plotId) { _plotId = plotId; }                            // ADDED  
    void SetNeighborhoodId(uint32 neighborhoodId) { _neighborhoodId = neighborhoodId; } // ADDED  
    void SetPlotIndex(uint8 plotIndex) { _plotIndex = plotIndex; }             // ADDED  
    ...
    void SetActive(bool active) { _isActive = active; }  
    void SetPositionX(float x) { _positionX = x; }                            // ADDED  
    void SetPositionY(float y) { _positionY = y; }                            // ADDED  
    void SetPositionZ(float z) { _positionZ = z; }                            // ADDED  
    void SetOrientation(float orientation) { _orientation = orientation; }     // ADDED  
...
public:  
    ...
    // Setters  
    void SetId(uint32 roomId) { _roomId = roomId; }                            // ADDED  
    void SetHouseId(uint32 houseId) { _houseId = houseId; }  
...
public:  
    ...
    // Setters  
    void SetId(uint32 placedDecorId) { _placedDecorId = placedDecorId; }       // ADDED  
    void SetHouseId(uint32 houseId) { _houseId = houseId; }  
    void SetRoomId(uint32 roomId) { _roomId = roomId; }  
    void SetDecorTemplateId(uint32 templateId) { _decorTemplateId = templateId; } // ADDED  
    ...
    void SetPlacementCost(uint32 cost) { _placementCost = cost; }              // ADDED  
...
public:  
    ...
    ObjectGuid GetGrantedByGuid() const { return _grantedByGuid; }             // ADDED  
  
    // Setters  
    void SetId(uint32 permissionId) { _permissionId = permissionId; }          // ADDED  
    void SetHouseId(uint32 houseId) { _houseId = houseId; }  
    ...
    void SetGrantedByGuid(ObjectGuid guid) { _grantedByGuid = guid; }          // ADDED  
