...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_DELETE_FROM_STORAGE,                  STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorDeleteFromStorage);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_LOCK,                                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorLock);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_MOVE,                                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorMove);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_PLACE,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorPlace);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REDEEM_DEFERRED_DECOR,                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorRedeemDeferredDecor);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REMOVE,                               STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorRemove);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_REQUEST_STORAGE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorRequestStorage);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_DYE_SLOTS,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorSetDyeSlots);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_EDIT_MODE,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorSetEditMode);
    DEFINE_HANDLER(CMSG_HOUSING_DECOR_SET_PET,                              STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingDecorSetPet);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_CREATE_FIXTURE,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingFixtureCreateFixture);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_DELETE_FIXTURE,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingFixtureDeleteFixture);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_CORE_FIXTURE,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingFixtureSetCoreFixture);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_EDIT_MODE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingFixtureSetEditMode);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_HOUSE_SIZE,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingFixtureSetHouseSize);
    DEFINE_HANDLER(CMSG_HOUSING_FIXTURE_SET_HOUSE_TYPE,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingFixtureSetHouseType);
    DEFINE_HANDLER(CMSG_HOUSING_GET_CURRENT_HOUSE_INFO,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingGetCurrentHouseInfo);
    DEFINE_HANDLER(CMSG_HOUSING_GET_PLAYER_PERMISSIONS,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingGetPlayerPermissions);
    DEFINE_HANDLER(CMSG_HOUSING_HOUSE_STATUS,                               STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingHouseStatus);
    DEFINE_HANDLER(CMSG_HOUSING_PHOTO_SHARING_CLEAR_AUTHORIZATION,          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingPhotoSharingClearAuthorization);
    DEFINE_HANDLER(CMSG_HOUSING_PHOTO_SHARING_COMPLETE_AUTHORIZATION,       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingPhotoSharingCompleteAuthorization);
    DEFINE_HANDLER(CMSG_HOUSING_RESET_HOUSE,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingResetHouse);
    DEFINE_HANDLER(CMSG_HOUSING_RESET_KIOSK_MODE,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingResetKioskMode);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_ADD,                                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomAdd);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_APPLY_COMPONENT_MATERIALS,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomApplyComponentMaterials);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_MOVE,                                  STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomMove);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_REMOVE,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomRemove);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_ROTATE,                                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomRotate);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_CEILING_TYPE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomSetCeilingType);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_COMPONENT_THEME,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomSetComponentTheme);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_DOOR_TYPE,                         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomSetDoorType);
    DEFINE_HANDLER(CMSG_HOUSING_ROOM_SET_LAYOUT_EDIT_MODE,                  STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingRoomSetLayoutEditMode);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_ACCEPT_NEIGHBORHOOD_OWNERSHIP,         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsAcceptNeighborhoodOwnership);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_DELETE_ALL_NEIGHBORHOOD_INVITES,       STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsDeleteAllNeighborhoodInvites);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_BNET_FRIEND_NEIGHBORHOODS,         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsGetBnetFriendNeighborhoods);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_HOUSE_FINDER_INFO,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsGetHouseFinderInfo);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_HOUSE_FINDER_NEIGHBORHOOD,         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsGetHouseFinderNeighborhood);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_PLAYER_HOUSES_INFO,                STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsGetPlayerHousesInfo);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GET_POTENTIAL_HOUSE_OWNERS,            STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsGetPotentialHouseOwners);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_GUILD_CREATE_NEIGHBORHOOD,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsGuildCreateNeighborhood);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_HOUSE_FINDER_IGNORE_NEIGHBORHOOD,      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsHouseFinderIgnoreNeighborhood);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_NEIGHBORHOOD_RESERVE_PLOT,             STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsNeighborhoodReservePlot);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_PLAYER_VIEW_HOUSES_BY_BNET_ACCOUNT,    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsPlayerViewHousesByBNetAccount);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_PLAYER_VIEW_HOUSES_BY_PLAYER,          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsPlayerViewHousesByPlayer);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_REJECT_NEIGHBORHOOD_OWNERSHIP,         STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsRejectNeighborhoodOwnership);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_RELINQUISH_HOUSE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, & WorldSession::Handle_HousingSvcsRelinquishHouse);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_START_TUTORIAL,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsStartTutorial);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_TELEPORT_TO_PLOT,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsTeleportToPlot);
    DEFINE_HANDLER(CMSG_HOUSING_SVCS_UPDATE_HOUSE_SETTINGS,                 STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::Handle_HousingSvcsUpdateHouseSettings);
